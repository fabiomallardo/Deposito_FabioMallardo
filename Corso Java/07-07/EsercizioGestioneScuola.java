...
class Studente extends Persona implements Registrabile{
    ...
    public void descriviRuolo(){
        System.out.println("--- Ciao sono " + getNome() +  " uno studente della classe: " + getClasseFrequentata() + " ---");
    }

    // Implementazione dell'interfaccia con il metodo registrazione che stampa il modo in cui è avvenuta la registrazione
